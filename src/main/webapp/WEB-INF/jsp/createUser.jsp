...
<td><form:input path="employeeId" placeholder="Enter your employee id" />
<form:errors class="text-error" path="employeeId"/>
</td></tr>
...
<tr><td><input type="button" class="btn btn-success btn-small" value="Back" onclick="javascript:gotoHomePage()"></td>
